...
const{validateProductRequest,validateAuth} = require('../middlewares');
...
app.post('/ecom/api/v1/products',[validateProductRequest.validateProductBody,validateAuth.verifyToken,validateAuth.isAdmin],productController.create)
//to update a category by id
app.put('/ecom/api/v1/products/:id',[validateProductRequest.validateProductBody,validateProductRequest.validateProductId,validateAuth.verifyToken,validateAuth.isAdmin],productController.update);
//to delete a category
app.delete('/ecom/api/v1/products/:id',[validateProductRequest.validateProductId,validateAuth.verifyToken,validateAuth.isAdmin],productController.delete)
