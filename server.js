...
function init() {
  const dummyCategories = [
    { name: "Electronics", description: "this is an electronic item" },
    { name: "Kitchenware", description: "this is an kitchenware item" },
  ];
  ...
  const dummyProducts = [
    ...
    { name: "Dido", description: "6 inch", cost: 100000, categoryId: 2 },
  ];
